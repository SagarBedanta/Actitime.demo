...
public class POM_ActitimeTypesOfWorkPage extends BasePage
{
	...
	@FindBy(xpath = "//a[.='sagar']/../..//a[contains(text(),'delete')]")
	private WebElement deleteworkLink;
	
	public POM_ActitimeTypesOfWorkPage(WebDriver driver)
	{
		this.driver=driver;
