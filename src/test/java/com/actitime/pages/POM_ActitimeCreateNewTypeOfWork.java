...
public class POM_ActitimeCreateNewTypeOfWork extends BasePage implements AutoConstant
{
	...
	public POM_ActitimeCreateNewTypeOfWork(WebDriver driver)
	{
		this.driver=driver;
		PageFactory.initElements(driver, this);
	}
	
	public void createworkMethod() throws IOException, InterruptedException
	{
